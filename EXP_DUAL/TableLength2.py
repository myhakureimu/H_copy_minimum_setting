...
prefix = f'python new_exp.py --gpu {gpuIdxStr} --random_seed {random_seed} --exp_name {exp_name} --split_based_on {split_based_on} --num_x {num_x} --max_table_length {max_table_length} --wandb 1 --epochs 512'
