                ...
                for icl_sampling in icl_sampling_list:
                    for h_prefix_format in h_prefix_format_list:
                        for icl_y_noise in icl_y_noise_list:
                            hyper = f'--sampling_disparity {sampling_disparity} --depth {depth} --lr {lr} --use_scheduler {use_scheduler} --wd {wd} --batch_size {batch_size} --modelName {modelName}\
